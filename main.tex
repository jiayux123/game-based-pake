...
We first give an informal, high-level overview of the ideas behind the security definitions for PAKE; what's said in this section applies to both the game-based and UC-security definitions. A few paragraphs in this section and \Cref{sec:UC} are taken almost verbatim from \Cref{EPRINT:Xu25}.
...
\NewSession & \longrightarrow & \TestPwd & \longrightarrow & \NewKey \\
\\
\fresh & \longrightarrow & \compromised & \longrightarrow & \completed \\
 & & \text{or }\interrupted & &
\end{array}
$
\end{center}
